...
var manager: PackedScene = preload("res://card/summon_cards/manager_card/manager.tscn")
...
#		print_debug("Player ID: ", player_id, " Summon:", new_waiter)
		new_manager.global_position = place_position + Vector2(randi_range(-50, 50), randi_range(-50, 50))
